...
const uint8_t room_data[] PROGMEM = {
    ...
    36, 5, 9, 0, 0b11111111, 0b11111100, 0b00101111, 0b00111111, 0b00001111, 0b10000000, 0b11110000, 0b00111111, 0b00111110, 0b00001111, 0b11111111, 0b11000000, //
...
#ifdef DEBUG
    Serial.print("dest door");
    Serial.println(destDoor);
#endif
